...
def create_event(organizer="", name="", comment="", address="", days=0):
    ...
    return Comments.objects.create(organizer=organizer,
...
class EventsIndexViewTests(TestCase):
    def test_no_events(self):
        ...
        """
        response = self.client.get(reverse('polls:index'))  # the list of events
    ...
    def test_single_event(self):
        ...
        create_event(organizer="Test Organizer",
                     name="Test Event Name",  # event name
    ...
    def test_multiple_events(self):
        ...
        create_event(organizer="Test Organizer 2",
                     name="Test Event Name 2",  # event name
...
class EventsCreateViewTests(TestCase):
    def test_event_form(self):
        ...
        """
        response = self.client.get(reverse('polls:comments'))  # the list of events
        self.assertEqual(response.status_code, 200)
